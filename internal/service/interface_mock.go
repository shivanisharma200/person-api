...
func (m *MockPerson) GetByID(ctx *gofr.Context, id string) (*model.Person, error) {
	m.ctrl.T.Helper()
...
func (m *MockPerson) Update(ctx *gofr.Context, id string, patient *model.Person) (*model.Person, error) {
	m.ctrl.T.Helper()
